package com.aiep.evsum2.config;
...
public class JHipsterBlockHoundIntegration implements BlockHoundIntegration {
    ...
    public void applyTo(BlockHound.Builder builder) {
        ...
        builder.allowBlockingCallsInside("com.aiep.evsum2.service.MailService", "sendEmailFromTemplate");
        builder.allowBlockingCallsInside("com.aiep.evsum2.security.DomainUserDetailsService", "createSpringSecurityUser");
