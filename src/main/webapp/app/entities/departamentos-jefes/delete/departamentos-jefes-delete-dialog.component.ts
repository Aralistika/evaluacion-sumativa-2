...
@Component({
  standalone: true,
  templateUrl: './departamentos-jefes-delete-dialog.component.html',
  imports: [SharedModule, FormsModule],
})
export class DepartamentosJefesDeleteDialogComponent {
  ...
  confirmDelete(id: number): void {
    this.departamentosJefesService.delete(id).subscribe(() => {
