...
type JefesFormGroupContent = {
  ...
  nombrejefe: FormControl<IJefes['nombrejefe']>;
  telefonojefe: FormControl<IJefes['telefonojefe']>;
};
...
export class JefesFormService {
  createJefesFormGroup(jefes: JefesFormGroupInput = { id: null }): JefesFormGroup {
    ...
    return new FormGroup<JefesFormGroupContent>({
      ...
      nombrejefe: new FormControl(jefesRawValue.nombrejefe),
      telefonojefe: new FormControl(jefesRawValue.telefonojefe),
    });
  }
