...
import com.aiep.evsum2.config.Constants;
import com.aiep.evsum2.domain.User;
import com.aiep.evsum2.repository.UserRepository;
import com.aiep.evsum2.security.AuthoritiesConstants;
import com.aiep.evsum2.service.MailService;
import com.aiep.evsum2.service.UserService;
import com.aiep.evsum2.service.dto.AdminUserDTO;
import com.aiep.evsum2.web.rest.errors.BadRequestAlertException;
import com.aiep.evsum2.web.rest.errors.EmailAlreadyUsedException;
import com.aiep.evsum2.web.rest.errors.LoginAlreadyUsedException;
 ...
 * <p>
 * This class accesses the {@link com.aiep.evsum2.domain.User} entity, and needs to fetch its collection of authorities.
 * <p>
